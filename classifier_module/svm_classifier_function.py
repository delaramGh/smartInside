...
def svm_classifier(org_img_path, gen_img_path, model="models\\all_svm90.pkl"):
    # load the model
...
if __name__ == "__main__":
    org_img = "C:\\Users\\ASUS\\...."
    gen_img = "C:\\Users\\ASUS\\..."
    
    result = svm_classifier(org_img, gen_img,  model="models\\all_svm90.pkl")

    if result:
        print("the generated image is valid!")
    else:
        print("the generated image is NOT valid!")
